...
function buildStructuralDesign(data) {
  ...
  html += '• 电加热器前后各 800mm 范围内风管及绝热材料采用不燃材料（GB 50019-2015 第6.3.8条），设超温保护开关（80℃切断）<br>';
  html += '• 加湿器设在加热器之后，蒸汽分配管距上游 ≥500mm（加湿器制造商推荐，保证蒸汽充分混合），距风机 ≥1000mm（ASHRAE 推荐，防止带水）<br>';
  ...
  html += '<tr>' +
    ...
    '<td>侧面</td>' +
    '<td>600×600</td>' +
    '<td>加热管需定期检查老化、变形；超温保护探头需校验；端子接线需检修；前后 800mm 范围内风管及绝热材料采用不燃材料（GB 50019-2015），需通过检修门确认</td></tr>';
  html += '<tr>' +
  ...
  html += '<tr>' +
    ...
    '<td>螺栓 4~6 套</td>' +
    '<td>蒸汽分配管距上游 ≥500mm（制造商推荐，充分混合），距风机 ≥1000mm（ASHRAE 推荐，防止带水），蒸汽管设保温层（岩棉 50mm）</td></tr>';
  html += '<tr>' +
...
function generateSelection(data) {
  ...
  var html =
    ...
    '<li>加热段前后各 800mm 范围内风管及绝热材料采用不燃材料（GB 50019-2015）</li>' +
    ...
    '<li>蒸汽分配管均匀分布在风道截面上，距上游元件 ≥ 500mm（制造商推荐，充分混合）</li>' +
    ...
    '<li>蒸汽分配管与风机之间需有 ≥ 1000mm 的直管段，确保蒸汽均匀混合（ASHRAE 推荐，防止带水）</li>' +
...
var qaKnowledge = [
  ...
  },
  {
    ...
    answer: '<p><b>电加热器选型步骤：</b></p><ol>' +
      ...
      '<li>加热段前后 ≥ 800mm 范围内风管及绝热材料采用不燃材料（GB 50019-2015）</li>' +
  ...
  },
  {
    ...
    answer: '<p><b>加湿量计算公式：</b></p>' +
      ...
      '<div class="engineering-exp"><strong>安装位置：</strong>加热器之后、风机之前。蒸汽分配管距上游 ≥500mm（制造商推荐），距风机 ≥1000mm（ASHRAE 推荐）。</div>'
  },
